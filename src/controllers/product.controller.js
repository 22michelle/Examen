...
productMethod.updateProductPoster = async(req, res) => {
    if (req.file) {
        ...
        if (permission) {
            ...
            if (productID) {
                ...
                if (product) {
                    try {
                        ...
                        return res.status(400).json({
                            status: false,
                            message: "Ocurrió un problema, intentelo de nuevo.",
                        });
                    }
                } else {
                    return res.status(400).json({
            ...
            return res.status(400).json({
                status: false,
                message: "No puesdes hacer esta acción.",
            });
        }
    } else {
        return res.status(400).json({
                ...
                if (product) {
                    ...
                    if (product.gallery.length + req.files.length <= 5) {
                        ...
                        try {
                            ...
                            return res.status(400).json({
                                status: false,
                                message: "La galería se actualizó correctamente.",
                            });
                        } catch (error) {
                        ...
                        return res.status(400).json({
                            status: false,
                            message: "La galería debe contener 5 fotos.",
                        });
                    }
                } else {
                    return res.status(400).json({
